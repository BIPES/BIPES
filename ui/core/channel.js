...
class mux {
  ...
  constructor () {
    ...
    this.ifunavailable = {
      webserial: ['https://iot-pete.ddns.net', 'the HTTPS version'],
      websocket: ['http://iot-pete.ddns.net', 'the HTTP version'],
      webbluetooth: ['https://iot-pete.ddns.net', 'the HTTPS version']
    }
  }
	/**
