var MSG = {
  ...
  shared: "מְשׁוּתָף",
  device: "התקן",
  linkTooltip: "שמור וקשר לבלוקים.",
  runTooltip: "הפעל את התוכנית שהוגדרה על ידי הבלוקים בסביבת העבודה.",
  badCode: "שגיאת תוכנית:\n%1",
  timeout: "חרגת מחזרות הביצוע המקסימליות.",
  trashTooltip: "זרוק את כל הבלוקים.",
  catLogic: "הִגָיוֹן",
  catLoops: "לולאות",
  catMath: "מתמטיקה",
  catText: "טֶקסט",
  ...
  listVariable: "רשימה",
  textVariable: "טֶקסט",
  httpRequestError: "הייתה בעיה עם הבקשה.",
  linkAlert: "שתף את הבלוקים שלך עם הקישור הזה:\n\n%1",
  hashError: "מצטערים, '% 1' אינו תואם לאף תוכנית שמורה.",
  xmlError: "לא ניתן היה לטעון את הקובץ השמור שלך. אולי זה נוצר עם גרסה אחרת של Blockly?",
  badXml: "שגיאה בניתוח XML:\n%1\n\nבחר 'אישור' כדי לנטוש את השינויים שלך או 'ביטול' כדי לערוך עוד יותר את ה-XML.",
  saveTooltip: "שמור בלוקים לקובץ.",
  loadTooltip: "טען בלוקים מהקובץ.",
  ...
  blocksLoadedFromFile: "בלוקים נטענו מהקובץ '%1'.",
